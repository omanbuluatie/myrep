...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= asset('/tpl') ?>/assets/images/favicon.png">
    <title>@yield('title')</title>
    <!-- This page CSS -->
    <!-- This page CSS -->
    <link href="<?= asset('/tpl') ?>/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
    
    <!-- Custom CSS -->
    <link href="<?= asset('/tpl') ?>/dist/css/style.css" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="<?= asset('/tpl') ?>/dist/css/pages/dashboard4.css" rel="stylesheet">
...
<body class="horizontal-nav skin-blue fixed-layout">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?= asset('/tpl') ?>/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?= asset('/tpl') ?>/assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span class="hidden-sm-down">
                            <!-- dark Logo text -->
                            <img src="<?= asset('/tpl') ?>/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="<?= asset('/tpl') ?>/assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                </div>
                <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img src="<?= asset('/tpl') ?>/assets/images/users/1.jpg" alt="user" class=""> <span class="hidden-md-down"><?= Auth::guard('admin')->user()->name ?> &nbsp;<i class="fa fa-angle-down"></i></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="{{ route('admin.logout') }}" class="dropdown-item"><i class="fa fa-power-off"></i> Keluar Aplikasi</a>
                                <!-- text-->
                            </div>
                        </li>
                        @endif
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="<?= asset('/tpl') ?>/assets/images/users/1.jpg" alt="user-img" class="img-circle"><span class="hide-menu">Mark Jeckson</span></a>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<?= asset('/tpl') ?>/assets/node_modules/jquery/jquery-3.2.1.min.js"></script>
    <!-- Bootstrap popper Core JavaScript -->
    <script src="<?= asset('/tpl') ?>/assets/node_modules/popper/popper.min.js"></script>
    <script src="<?= asset('/tpl') ?>/assets/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="<?= asset('/tpl') ?>/dist/js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="<?= asset('/tpl') ?>/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?= asset('/tpl') ?>/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="<?= asset('/tpl') ?>/dist/js/custom.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--Sky Icons JavaScript -->
    <script src="<?= asset('/tpl') ?>/assets/node_modules/skycons/skycons.js"></script>
    <!--morris JavaScript -->
    <script src="<?= asset('/tpl') ?>/assets/node_modules/raphael/raphael-min.js"></script>
    <script src="<?= asset('/tpl') ?>/assets/node_modules/morrisjs/morris.min.js"></script>
    <script src="<?= asset('/tpl') ?>/assets/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Chart JS -->
    <script src="<?= asset('/tpl') ?>/dist/js/dashboard4.js"></script>
    @yield('scripts')
